...
% Due to Tommy (@tommyod)
Figure~7.1:
The sign of $y$ is swapped in the subfigures.
The choice is arbitrary, but for consistency with Figure~7.3, the notation in the leftmost subfigure is preferred.
